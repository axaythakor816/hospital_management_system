...
<?php
  require_once('includes/config.php');
   ...
   {
    $query = "SELECT * FROM `registration` WHERE `name`='$_POST[name]' or `email`='$_POST[name]'";
       ...
       if($result)
       {
           if(mysqli_num_rows($result)==1)
           {
               ...
               if(password_verify($_POST['password'],$result_fetch['password']))
               {
                ...
                header("location: index-multipage.php");
               }
            ...
            <div class="form-box login">
                <form action="#" method="POST">
                    ...
                    <div class="login-register">
                        <p>Don't have an account? <a href="registration.php" class="register-link">Sign Up</a></c></p>
                    </div>
                </form>
            </div>
